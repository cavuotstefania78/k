------------------------------------------------
-- This Source Was Developed By (BlackPink) @ZH7ZZ.--
--   This Is The Source Channel @ZH7ZZ .   --
--                - B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸-                 --
--        -- https://t.me/ZH7ZZ --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,5030377536}  
...
if UserId == 5030377536 then
Status = true
elseif UserId == 5030377536 then
Status = true
...
return {
Lock     = '[B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸](https://t.me/YYQQO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸](https://t.me/YYQQO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸](https://t.me/YYQQO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸](https://t.me/YYQQO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸](https://t.me/YYQQO)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸](https://t.me/YYQQO)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if tonumber(msg.sender.user_id) == 5030377536 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5030377536 then
...
{
{text = 'B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸 ⁦', url='https://t.me/YYQQO'},
},
}
}
...
{{text =news,url = "https://t.me/YYQQO"}, },}}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/YYQQO'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
data = {
{
{text = '- قناة السورس', url = 't.me/YYQQO'}, 
},
}
}
...
local UserId_Info = LuaTele.searchPublicChat("ZH7ZZ")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/ZH7ZZ"}
},
{
{text = '❲ B𝗹𝗮𝗰𝗸𝗽𝗶𝗻𝗸 ❳', url = "https://t.me/YYQQO"},
},
...
data = {
{
{text = 'Channel Source ،', url = 't.me/YYQQO'}, 
},
{
...
{
{text = 'Developer Source !', url = 't.me/ZH7ZZ'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
data = {
{
{text = '᥀ السورس .', url = 't.me/YYQQO'},{text = '᥀ لتنصيب بوت .', url = 't.me/ZH7ZZ'}, 
},
{
